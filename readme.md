...
| No Fire + 👤 Person | AREA SAFE                    | ⚪ White ON                               |
...
- **`Sano Chretien`** – [@chretien527](https://github.com/chretien527)
- **`Ishimwе Linaa`** – [@Linaa0](https://github.com/Linaa0)
- **`Bruce NIBEZA`** – [@Bruxe-Dev](https://github.com/Bruxe-Dev)
